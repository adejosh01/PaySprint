                ...
                <div className="w-[1032px] h-[430px] border-[0.5px] mt-4 rounded-md">
                    <div>
                        <div className="flex items-center w-[1032px] h-[60px] bg-[#f7f7f7] border-[0.5px] rounded-md">
                            <button className={`flex-container py-7 my-2 px-8 w-[344px] h-[60px] text-[#2d334a]
                            ...
                            <button className={`flex-container py-7 my-2 px-8 w-[344px] h-[60px] text-[#2d334a] rounded-lg
